...
#define CAN_CTRLMODE_RESTRICTED 0x800
#define CAN_CTRLMODE_XL 0x1000
#define CAN_CTRLMODE_XL_TDC_AUTO 0x2000
#define CAN_CTRLMODE_XL_TDC_MANUAL 0x4000
#define CAN_CTRLMODE_XL_TMS 0x8000
...
enum {
  IFLA_CAN_PWM_UNSPEC,
  IFLA_CAN_PWM_PWMS_MIN,
  IFLA_CAN_PWM_PWMS_MAX,
  IFLA_CAN_PWM_PWML_MIN,
  IFLA_CAN_PWM_PWML_MAX,
  IFLA_CAN_PWM_PWMO_MIN,
  IFLA_CAN_PWM_PWMO_MAX,
  IFLA_CAN_PWM_PWMS,
  IFLA_CAN_PWM_PWML,
  IFLA_CAN_PWM_PWMO,
  __IFLA_CAN_PWM,
