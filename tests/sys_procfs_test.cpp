...
TEST(sys_procfs, types) {
  [[maybe_unused]] elf_greg_t reg = {};
  [[maybe_unused]] elf_gregset_t regs = {};
  [[maybe_unused]] elf_fpregset_t fp_regs = {};
  [[maybe_unused]] prgregset_t pr_g_regs = {};
  [[maybe_unused]] prfpregset_t pr_fp_regs = {};
